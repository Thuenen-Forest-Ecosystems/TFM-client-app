...
@ConnectOfflineFirstWithSupabase(supabaseConfig: SupabaseSerializable(tableName: 'plot'))
class Plot extends OfflineFirstWithSupabaseModel {
  ...
  Plot({String? id, required this.cluster_id}) : id = id ?? const Uuid().v4();
}
