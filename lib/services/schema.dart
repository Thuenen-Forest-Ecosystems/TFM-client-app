...
Schema schema = Schema(([
  ...
  const Table('records', [
    ...
    Column.text('responsible_control_troop'),
    Column.text('completed_at_state'),
    Column.text('completed_at_troop'),
    Column.text('completed_at_control_troop'),
  ...
  const Table('organizations_lose', [
    Column.text('created_at'),
    Column.text('name'),
    Column.text('description'),
    Column.text('organization_id'),
    Column.text('responsible_organization_id'),
    Column.text('troop_id'),
    Column.text('record_ids'),
    Column.text('cluster_ids'),
  ]),
  const Table('troop', [
