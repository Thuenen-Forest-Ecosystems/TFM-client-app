...
class _BluetoothIconCombinedState extends State<BluetoothIconCombined> {
  ...
  Widget build(BuildContext context) {
    ...
    final isInternalGPS = gpsProvider.listeningPosition && !hasGPSConnection && !isMockGPS;
    ...
    final icon = isMockGPS ? Icons.route : (isInternalGPS ? Icons.smartphone : Icons.satellite_alt);
    ...
    return IconButton(
      icon: Icon(
        ...
        color: hasValidPosition
            ? Colors.green
            : (hasGPSConnection || isGPSConnecting || isPhoneGpsSource ? Colors.orange : null),
      ),
          ...
          Consumer<GpsPositionProvider>(
            builder: (context, gpsProvider, child) {
              ...
              if (gpsProvider.connectedDevice != null) {
                ...
                final extrasSatellites = gpsProvider.lastAndroidExtrasSatellites;
                ...
                final hasExtrasQuality =
                    extrasSatellites != null || extrasHdop != null || extrasPdop != null;
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (Platform.isAndroid && index == 1) {
                  return ListTile(
                    leading: Icon(Icons.route, color: isMockGPS ? Colors.green : Colors.grey),
                    title: const Text('Mocked GPS (Android/NTRIP)'),
