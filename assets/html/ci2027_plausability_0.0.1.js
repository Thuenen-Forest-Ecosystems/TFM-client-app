(function (global, factory) {
	...
	var title = "Clusters";
	var description = "Clusters schema";
	var type = "array";
	var items = {
		title: "Cluster",
		description: "Cluster schema",
		type: "object",
		properties: {
			intkey: {
				title: "intkey",
				description: "Column intkey from nfi2022",
				type: "string",
				$migration: {
					nfi2022: {
						source: [
						...
						pointer: "bwineu.dbo.b3_tnr.intkey"
					}
				}
			},
			cluster_name: {
			...
			state_responsible: {
				...
				$migration: {
					nfi2022: {
						...
						function_arguments: {
							table: "code_bwineu.dbo.x3_bl_aufn",
							from: "ICode",
							to: "ACode"
						},
						source: [
						...
						pointer: "bwineu.dbo.b3_tnr.AufnBl"
					}
				}
			},
			topo_map_sheet: {
				title: "Topographic Map Sheet",
				description: "The topographic map sheet",
				type: "number",
				minimum: 0,
				$migration: {
					nfi2022: {
						...
						pointer: "bwineu.dbo.b3_tnr.TopKar"
					}
				}
			},
			states_affected: {
				title: "States Affected",
				description: "The states affected by the cluster",
				type: "array",
				$migration: {
					nfi2022: {
						"function": "sqlArrayToArray",
						source: [
							"Laender"
						],
						pointer: "bwineu.dbo.b3_tnr.Laender"
					}
				},
				items: {
					title: "State",
			...
			grid_density: {
				title: "Grid Density",
				description: "The grid density of the cluster",
				type: "string",
				minimum: 0,
				$migration: {
					nfi2022: {
						lookup: "lookup_grid_density",
						source: [
							"Netz"
						],
						pointer: "bwineu.dbo.b3_tnr.Netz"
					}
				}
			},
			cluster_status: {
				...
				minimum: 0,
				$migration: {
					lookup: "lookup_cluster_status",
					nfi2022: {
						source: [
							"Ktg"
						],
						pointer: "bwineu.dbo.b3_tnr.Ktg"
					}
				}
			},
			cluster_situation: {
				title: "Cluster Situation",
				description: "The situation of the cluster",
				type: "string",
				minimum: 0,
				$migration: {
					nfi2022: {
						lookup: "lookup_cluster_situation",
						source: [
							"b3f_tnr_vorkl",
							"0",
							"TrStatus"
						],
						pointer: "bwineu.dbo.b3f_tnr_vorkl.TrStatus"
					}
				}
			},
			plots: {
				title: "Plots",
				description: "The plots in the cluster",
				type: "array",
				items: {
					title: "Plots",
					type: "object",
					properties: {
						...
						tree: {
							...
							items: {
								...
								properties: {
									...
									tree_number: {
										title: "Baumnummer",
										description: "Eindeutige Baumnummer",
										type: "integer",
										minimum: 1,
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Bnr"
											}
										}
									},
									tree_marked: {
										title: "Markiert",
										description: "Baum permanent markiert",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Perm"
											}
										}
									},
									tree_status: {
										title: "Probebaumkennziffer",
										description: "Probebaumkennziffer",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_tree_status",
												source: [
													"Pk"
												],
												pointer: "bwineu.dbo.b3v_wzp.Pk"
											}
										}
									},
									azimuth: {
										title: "Azimut",
										description: "Azimut [gon] des Baumes",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Azi"
											}
										}
									},
									distance: {
										title: "Horizontalentfernung",
										description: "Horizontalentfernung [cm] des Baumes",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Hori"
											}
										}
									},
									tree_species: {
										...
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Ba"
											}
										}
									},
									dbh: {
										title: "Brusthöhendurchmesser",
										description: "gemessener BHD [mm]",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.M_Bhd"
											}
										}
									},
									dbh_height: {
										title: "Messhöhe des BHD",
										description: "Messhöhe des BHD [cm] (Standard 130 cm)",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.M_hBhd"
											}
										}
									},
									tree_height: {
										title: "Baumhöhe",
										description: "gemessene Baumhöhe [dm]",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.M_Hoe"
											}
										}
									},
									stem_height: {
										title: "Baumhöhe",
										description: "gemessene Stammhöhe [dm]",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.M_StHoe"
											}
										}
									},
									tree_height_azimuth: {
										title: "Azimut des Höhenmessbaums",
										description: "Azimut [Gon] der Messposition zum Höhenmessbaum",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.MPos_Azi"
											}
										}
									},
									tree_height_distance: {
										title: "Distanz zum Höhenmessbaum",
										description: "Horizontalentfernung [cm] der Messposition zum Höhenmessbaum",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.MPos_Hori"
											}
										}
									},
									tree_age: {
										title: "Distanz zum Höhenmessbaum",
										description: "Alter des Baumes [Jahre]",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Al_ba"
											}
										}
									},
									stem_breakage: {
										title: "Höhenkennziffer",
										description: "Höhenkennziffer",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_stem_breakage",
												source: [
													"Kh"
												],
												pointer: "bwineu.dbo.b3v_wzp.Kh"
											}
										}
									},
									stem_form: {
										...
										$migration: {
											nfi2022: {
												lookup: "lookup_stem_form",
												source: [
													"Kst"
												],
												pointer: "bwineu.dbo.b3v_wzp.Kst"
											}
										}
									},
									pruning: {
										...
										$migration: {
											nfi2022: {
												lookup: "lookup_pruning",
												source: [
													"Ast"
												],
												pointer: "bwineu.dbo.b3v_wzp.Ast"
											}
										}
									},
									pruning_height: {
										...
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Ast_Hoe"
											}
										}
									},
									within_stand: {
										title: "Bestandeszugehörigkeit",
										description: "RAUS: Bestandeszugehörigkeit",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Bz"
											}
										}
									},
									stand_layer: {
										title: "Bestandesschicht",
										description: "Bestandesschicht",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_stand_layer",
												source: [
													"Bs"
												],
												pointer: "bwineu.dbo.b3v_wzp.Bs"
											}
										}
									},
									damage_dead: {
										title: "abgestorben",
										description: "frisch abgestorben",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Tot"
											}
										}
									},
									damage_peel_new: {
										title: "Schälschäden",
										description: "jüngere/frische Schälschäden",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.jSchael"
											}
										}
									},
									damage_peel_old: {
										title: "Schälschäden",
										description: "ältere Schälschäden",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.aeSchael"
											}
										}
									},
									damage_logging: {
										title: "Rücke- und Fällschäden",
										description: "Rücke- und Fällschäden",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Ruecke"
											}
										}
									},
									damage_fungus: {
										title: "Pilz",
										description: "Pilzkonsolen",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Pilz"
											}
										}
									},
									damage_resin: {
										title: "Harzlachten",
										description: "Harzlachten",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Harz"
											}
										}
									},
									damage_beetle: {
										title: "Käferbohrlöcher",
										description: "Käferbohrlöcher",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Kaefer"
											}
										}
									},
									damage_other: {
										title: "sonstige Stammschäden",
										description: "sonstige Stammschäden",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.sStamm"
											}
										}
									},
									cave_tree: {
										title: "Höhlenbaum",
										description: "Biotop - Höhlenbaum",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Hoehle"
											}
										}
									},
									crown_dead_wood: {
										title: "Lichtkrone abgestorben",
										description: "Biotop - mehr als ein Drittel der Lichtkrone abgestorben oder drei starke Totäste",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Bizarr"
											}
										}
									},
									tree_top_drought: {
										title: "Zopftrocknis",
										description: "Zopftrocknis",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Uralt"
											}
										}
									},
									bark_pocket: {
										title: "Rinde",
										description: "mit sich lösender Rinde oder Rindentasche >500 cm². Mindestbereite 10 cm",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.Horst"
											}
										}
									},
									biotope_marked: {
										title: "MarkBiotop",
										description: "Biotop - Speziell markierter Biotopbaum",
										type: [
											"boolean",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wzp.MBiotop"
											}
										}
									},
									bark_condition: {
										title: "Rindenzustand",
										description: "Rindenzustand für frisch abgestorbene WZP4-Bäume",
										type: [
											"integer",
											"null"
										],
						...
						deadwood: {
							...
							items: {
								...
								properties: {
									...
									tree_species_group: {
										title: "Baumartengruppe",
										description: "Baumartengruppe für Totholz",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_tree_species_group",
												source: [
													"Tbagr"
												],
												pointer: "bwineu.dbo.b3v_tot.Tbagr"
											}
										}
									},
									dead_wood_type: {
										title: "Totholztyp",
										description: "Totholztyp",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_dead_wood_type",
												source: [
													"Tart"
												],
												pointer: "bwineu.dbo.b3v_tot.Tart"
											}
										}
									},
									decomposition: {
										title: "Zersetzungsgrad",
										description: "Zersetzungsgrad",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_decomposition",
												source: [
													"Tzg"
												],
												pointer: "bwineu.dbo.b3v_tot.Tzg"
											}
										}
									},
									length_height: {
										title: "Länge / Höhe",
										description: "Länge / Höhe Totholz [dm]",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_tot.Tl"
											}
										}
									},
									diameter_butt: {
										title: "maximale Durchmesser",
										description: "Durchmesser am dicken Ende [cm] (liegende Bruchstücke); Schnittflächen- (Stöcke), Bhd (mit Wurzel, >=130 cm Länge)",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_tot.Tbd"
											}
										}
									},
									diameter_top: {
										title: "minimale Durchmesser",
										description: "Durchmesser am dünnen Ende [cm] (nur bei liegenden Totholz OHNE Wurzelanlauf)",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_tot.Tsd"
											}
										}
									},
									count: {
										title: "Anzahl",
										description: "Anzahl gleichartiger Totholzstücke",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_tot.Anz"
											}
										}
									},
									bark_pocket: {
										title: "Rindentaschen",
										description: "Rindentaschen > 500 cm² mit einer Mindestbreite von 10 cm (nur für stehendes Totholz)",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_tot.TRinde"
											}
										}
									}
								}
						...
						position: {
							...
							items: {
								...
								properties: {
									position_median: {
										title: "Koordinaten Median",
										description: "Latitude / Longitude",
										type: "string",
										$migration: {
											nfi2022: {
												"function": "toLatLonMED",
												source: [
													"LAT_MED"
												],
												pointer: "bwineu.dbo.b3v_gps.LAT_MED"
											}
										},
										items: {
											type: [
									...
									position_mean: {
										title: "Koordinaten Mittel",
										description: "Latitude / Longitude",
										type: "string",
										$migration: {
											nfi2022: {
												"function": "toLatLonMEAN",
												source: [
													"LAT_MED"
												],
												pointer: "bwineu.dbo.b3v_gps.LAT_MED"
									...
									hdop_mean: {
										title: "Genauigkeit",
										description: "Genauigkeit der Positionsmessung",
										type: [
											"number",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_gps.HDOP"
											}
										}
									},
									pdop_mean: {
										...
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_gps.PDOP"
											}
										}
									},
									satellites_count_mean: {
										title: "Anzahl der Satelliten",
										description: "Mittlere Anzahl der Satelliten",
										type: [
											"number",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_gps.NumSat"
											}
										}
									},
									measurement_count: {
										title: "Anzahl der Messungen",
										description: "Anzahl der GPS Messungen",
										type: [
											"number",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_gps.AnzahlMessungen"
											}
										}
									},
									rtcm_age: {
										...
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_gps.RTCMAlter"
											}
										}
									},
									start_measurement: {
										title: "Startzeit",
										description: "Beginn der Messung",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_gps.UTCStartzeit"
											}
										}
									},
									stop_measurement: {
										title: "Stopzeit",
										description: "Ende der Messung",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_gps.UTCStopzeit"
											}
										}
									},
									device_gnss: {
										title: "GNSS-Gerät",
										description: "Technische Bezeichnung des Gerätes",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_gps.Geraet"
											}
										}
									},
									quality: {
										title: "Qualität",
										description: "Qualität der verwendeten GNSS-Einmessung",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_gnss_quality",
												source: [
													"GNSS_Qualitaet"
												],
												pointer: "bwineu.dbo.b3v_gps.GNSS_Qualitaet"
											}
										}
									}
								}
						...
						edges: {
							...
							items: {
								...
								properties: {
									...
									edge_status: {
										title: "Kennziffer des Wald-/Bestandesrandes",
										description: "Kennziffer des Wald-/Bestandesrandes",
										type: [
											"string",
											"null"
										],
										"default": "0",
										$migration: {
											lookup: "lookup_edge_status",
											nfi2022: {
												source: [
													"Rk"
												],
												pointer: "bwineu.dbo.b3v_wrand.Rk"
											}
										}
									},
									edge_number: {
										title: "Waldrandnummer",
										description: "Waldrandnummer",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_wrand.Rnr"
											}
										}
									},
									edge_type: {
										title: "Art des Wald- /Bestandesrandes",
										description: "Art des Wald- /Bestandesrandes",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_edge_type",
												source: [
													"Rart"
												],
												pointer: "bwineu.dbo.b3v_wrand.Rart"
											}
										}
									},
									terrain: {
										title: "Vorgelagertes Terrain",
										description: "Vorgelagertes Terrain",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_terrain",
												source: [
													"Rterrain"
												],
												pointer: "bwineu.dbo.b3v_wrand.Rterrain"
											}
										}
									},
									edges: {
										title: "Geometrie des Wald-/Bestandesrandes",
										description: "Geometrie des Wald-/Bestandesrandes",
										type: [
											"array",
											"null"
										],
										$migration: {
											nfi2022: {
												"function": "edgesToJSONB",
												function_arguments: {
													table: "bwineu.dbo.b3_ecke",
													where: "Tnr =  AND Enr = ",
													to: "Soll_Y_WGS84, Soll_X_WGS84"
												},
												source: [
													"Rterrain"
												],
										...
										items: {
											...
											properties: {
												azimuth: {
													title: "Azimut",
													description: "Azimut in Gon",
													type: "integer"
												},
												distance: {
													title: "Distanz",
													description: "Distanz in cm",
													type: "integer"
												}
											}
										}
									...
									tree_species: {
										...
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_b0.Ba"
											}
										}
									},
									browsing: {
										title: "Verbiss",
										description: "einfacher oder mehrfacher Verbiss der Terminalknospe",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_browsing",
												source: [
													"Biss"
												],
												pointer: "bwineu.dbo.b3v_b0.Biss"
											}
										}
									},
									tree_size_class: {
										title: "Baumgrößenklasse",
										description: "Baumgrößenklasse",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												lookup: "lookup_tree_size_class",
												source: [
													"Gr"
												],
												pointer: "bwineu.dbo.b3v_b0.Gr"
											}
										}
									},
									damage_peel: {
										title: "Schälschäden",
										description: "Schälschäden (frische und/oder ältere)",
										type: [
											"string",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_b0.Schael"
											}
										}
									},
									protection_individual: {
										...
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_b0.Schu"
											}
										}
									},
									tree_count: {
										title: "Anzahl gleichartiger Bäume",
										description: "Anzahl gleichartiger Bäume",
										type: [
											"integer",
											"null"
										],
						...
						structure_lt4m: {
							title: "structure_lt4m",
							description: "structure_lt4m",
							type: [
								"array",
								"null"
							],
									...
									tree_species: {
										...
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_le4m_ba.Ba"
											}
										}
									},
									coverage: {
										title: "Anteil der Baumart in Zehntel",
										description: "Anteil der Baumart in Zehntel (Deckungsgrad entspricht 10 Zehntel = 100 %)",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_le4m_ba.Anteil"
											}
										}
									},
									regeneration_type: {
										title: "Verjüngungsart",
										description: "Verjüngungsart der Baumart",
										type: [
											"integer",
											"null"
										],
										$migration: {
											nfi2022: {
												...
												pointer: "bwineu.dbo.b3v_le4m_ba.Vart"
											}
										}
									}
								}
						...
						center_location: {
							...
							$migration: {
								nfi2022: {
									"function": "fromSollWGS84",
									source: [
										"Soll_X_WGS84"
									],
									pointer: "bwineu.dbo.b3_tnr.Soll_X_WGS84"
								}
							}
						},
						cluster_id: {
						...
						sampling_stratum: {
							...
							minimum: 0,
							$migration: {
								lookup: "lookup_sampling_stratum",
								nfi2022: {
									source: [
										"Vbl"
									],
									pointer: "bwineu.dbo.b3_tnr.Vbl"
								}
							}
						},
						federal_state: {
							title: "Federal State",
							description: "Kürzel des Aufnahmelandes",
							type: "string",
							$migration: {
								nfi2022: {
									lookup: "lookup_state",
									...
									pointer: "bwineu.dbo.b3_ecke.dathoheit"
								}
							}
						},
						growth_district: {
							title: "Wuchsbezirk",
							description: "Wuchsbezirk",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3_ecke.Wb"
								}
							}
						},
						forest_status: {
							title: "Waldentscheid",
							description: "Waldentscheid an der Traktecke",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_forest_status",
									source: [
										"b3f_ecke_vorkl",
										"0",
										"Wa"
									],
									pointer: "bwineu.dbo.b3f_ecke_vorkl.Wa"
								}
							}
						},
						accessibility: {
							...
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3f_ecke_vorkl.Begehbar"
								}
							}
						},
						forest_office: {
							title: "Forstamt",
							description: "Forstamt",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3f_ecke_vorkl.FA"
								}
							}
						},
						elevation_level: {
							...
							$migration: {
								nfi2022: {
									lookup: "lookup_elevation_level",
									source: [
										"b3f_ecke_vorkl",
										"0",
										"NatHoe"
									],
									pointer: "bwineu.dbo.b3f_ecke_vorkl.NatHoe"
								}
							}
						},
						property_type: {
							title: "Eigentumsart",
							description: "Eigentumsart",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_property_type",
									source: [
										"b3f_ecke_vorkl",
										"0",
										"Eg"
									],
									pointer: "bwineu.dbo.b3f_ecke_vorkl.Eg"
								}
							}
						},
						property_size_class: {
							title: "Eigentumsgrößenklasse",
							description: "Eigentumsgrößenklasse",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_property_size_class",
									source: [
										"b3f_ecke_vorkl",
										"0",
										"EgGrkl"
									],
									pointer: "bwineu.dbo.b3f_ecke_vorkl.EgGrkl"
								}
							}
						},
						forest_community: {
							title: "Waldgesellschaft",
							description: "potentielle natürliche Waldgesellschaft",
							type: [
								"string",
								"null"
							],
							$migration: {
								lookup: "lookup_forest_community_field",
								nfi2022: {
									source: [
										"b3f_ecke_vorkl",
										"0",
									...
									pointer: "bwineu.dbo.b3f_ecke_vorkl.NatWgV"
								}
							}
						},
						forest_community_field: {
							title: "Waldgesellschaft",
							description: "potentielle natürliche Waldgesellschaft im Feld zu bestimmen",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.NatWG"
								}
							}
						},
						ffh_forest_type: {
							title: "Waldlebesraumtyp",
							description: "Waldlebesraumtyp",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_ffh_forest_type_field",
									source: [
										"b3f_ecke_vorkl",
										"0",
										"WLT_V"
									],
									pointer: "bwineu.dbo.b3f_ecke_vorkl.WLT_V"
								}
							}
						},
						ffh_forest_type_field: {
							title: "Waldlebesraumtyp",
							description: "Waldlebesraumtyp im Feld zu bestimmen",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.WLT"
								}
							}
						},
						land_use_before: {
							title: "Landnutzungsart",
							description: "Landnutzungsart",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_land_use",
									source: [
										"b3f_ecke_vorkl",
										"0",
										"LaNu"
									],
									pointer: "bwineu.dbo.b3f_ecke_vorkl.LaNu"
								}
							}
						},
						land_use_after: {
							title: "Waldlebesraumtyp (TODO CHECKED:  bwineu.dbo.bv_ecke.LaNu ?)",
							description: "Waldlebesraumtyp im Feld zu bestimmen",
							type: [
								"string",
								"null"
							...
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.bv_ecke.LaNu"
								}
							}
						},
						coast: {
							title: "Küsten-/Strandnähe",
							description: "bewaldete Küstendüne (unmittelbar in Küsten- bzw. Strandnähe)",
							type: [
								"boolean",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3f_ecke_vorkl.Kueste"
								}
							}
						},
						sandy: {
							title: "Sand / Vegetationszeiger",
							description: "trockener sandiger Boden oder wechseltrockene Standorte oder Vegetationszeiger oder andere gesicherte Bestätigung",
							type: [
								"boolean",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3f_ecke_vorkl.Gestein"
								}
							}
						},
						protected_landscape: {
							title: "Landschaftschutzgebiet",
							description: "neu verschnitten mit Soll-Koordinaten (EPSG: 31463 DHDN GK3; nach EPSG:25832 projiziert) von S. Schnell mit BfN-Layer Stand 2018; übernommen 30.10.2020 (Thünen-Institut)",
							type: [
								"boolean",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3f_ecke_vorkl.LSG"
								}
							}
						},
						histwald: {
							title: "Historischer Wald",
							description: "Historischer Wald, seit langem (bisher nur NI) Input für WLT_Algorithmus",
							type: [
								"boolean",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3f_ecke_vorkl.HistWald"
								}
							}
						},
						harvest_restriction: {
							title: "Nutzungseinschränkung",
							description: "Nutzungseinschränkung (x3_ne)",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3f_ecke_vorkl.Ne"
								}
							}
						},
						harvest_restriction_source: {
							title: "Nutzungseinschränkung",
							description: "Nutzungseinschränkung (_x3_ne) (TODO CHECKED:  bwineu.dbo.b3f_ecke_vorkl.Ne ?)",
							type: "array",
							$migration: {
								nfi2022: {
									"function": "toHarvestRestriction",
									source: [
										"b3f_ecke_vorkl",
										"0",
										"Ne"
						...
						landmark_azimuth: {
							title: "Azimut",
							description: "Markanter Geländepunkt, hier Azimut [gon]",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.Mark_Azi"
								}
							}
						},
						landmark_distance: {
							title: "Horizontalentfernung",
							description: "Markanter Geländepunkt, hier Horizontalentfernung [cm]",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.Mark_Hori"
								}
							}
						},
						landmark_note: {
							title: "Geländepunkt",
							description: "Kurz-Beschreibung eines markanten Geländepunktes",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.Mark_Beschreibung"
								}
							}
						},
						marker_status: {
							title: "Markierung",
							description: "Permanente Trakteckenmarkierung gefunden/gesetzt",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_marker_status",
									source: [
										"b3v_ecke_feld",
										"0",
										"Perm"
									],
									pointer: "bwineu.dbo.b3v_ecke_feld.Perm"
								}
							}
						},
						marker_azimuth: {
							title: "Azimut",
							description: "Position (Azimut [gon]) der permanenten Trakteckenmarkierung",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.Perm_Azi"
								}
							}
						},
						marker_distance: {
							title: "Horizontalentfernung",
							description: "Position (Horizontalentfernung [cm]) der permanenten Trakteckenmarkierung",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.Perm_Hori"
								}
							}
						},
						marker_profile: {
							title: "Profil",
							description: "Profil der permanenten Trakteckenmarkierung; fakultativ",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_marker_profile",
									source: [
										"b3v_ecke_feld",
										"0",
										"Perm_Profil"
									],
									pointer: "bwineu.dbo.b3v_ecke_feld.Perm_Profil"
								}
							}
						},
						terrain_form: {
							title: "Geländeform",
							description: "Geländeform",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_terrain_form",
									source: [
										"b3v_ecke_feld",
										"0",
										"Gform"
									],
									pointer: "bwineu.dbo.b3v_ecke_feld.Gform"
								}
							}
						},
						terrain_slope: {
							title: "Geländeneigung",
							description: "Geländeneigung [Grad]",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.Gneig"
								}
							}
						},
						terrain_exposure: {
							title: "Geländeexposition",
							description: "Geländeexposition [Gon]",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.Gexp"
								}
							}
						},
						management_type: {
							...
							$migration: {
								nfi2022: {
									lookup: "lookup_management_type",
									source: [
										"b3v_ecke_feld",
										"0",
										"Be"
									],
									pointer: "bwineu.dbo.b3v_ecke_feld.Be"
								}
							}
						},
						harvesting_method: {
							title: "Ernte",
							description: "Bedingungen für die Holzernte",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_harvesting_method",
									source: [
										"b3v_ecke_feld",
										0,
										"Be"
						...
						biotope: {
							title: "GeschütztesBiotop",
							description: "Besonders geschütztes Waldbiotop",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.Biotop"
								}
							}
						},
						stand_structure: {
							title: "Aufbau",
							description: "Aufbau der Bestockung",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_stand_structure",
									source: [
										"b3v_ecke_feld",
										0,
										"Ab"
									],
									pointer: "bwineu.dbo.b3v_ecke_feld.Ab"
								}
							}
						},
						stand_age: {
							title: "Alter",
							description: "Alter der Bestockung [Jahre], zum Stichjahr 2022",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.Al_best"
								}
							}
						},
						stand_dev_phase: {
							title: "Phase/Dimensionsklasse",
							description: "Entwicklungsphase / Wuchsklasse / Dimensionsklasse",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_stand_dev_phase",
									source: [
										"b3v_ecke_feld",
										"0",
										"Phase"
									],
									pointer: "bwineu.dbo.b3v_ecke_feld.Phase"
								}
							}
						},
						stand_layer_reg: {
							title: "Schicht",
							description: "Bestandesschicht aller jungen Bäume der Probekreise r=1 / 2m (Baumgrößen 0-6)",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.B0_Bs"
								}
							}
						},
						fence_reg: {
							title: "Zaun",
							description: "Zäunung der Probeflächen r=1 / 2 m (Baumgrößen 0-6)",
							type: [
								"boolean",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.B0_Zaun"
								}
							}
						},
						trees_greater_4meter_mirrored: {
							title: "Spiegelungsart",
							description: "Art der Spiegelung aller Bäume der Bestockung über 4 m Höhe",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_trees_less_4meter_mirrored",
									source: [
										"b3v_ecke_feld",
										"0",
										"SchiGT4_Sp"
									],
									pointer: "bwineu.dbo.b3v_ecke_feld.SchiGT4_Sp"
								}
							}
						},
						trees_greater_4meter_basal_area_factor: {
							title: "Zählfaktor",
							description: "Zählfaktor aller Bäume der Bestockung über 4 m Höhe",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_trees_less_4meter_count_factor",
									source: [
										"b3v_ecke_feld",
										"0",
										"SchiGT4_ZF"
									],
									pointer: "bwineu.dbo.b3v_ecke_feld.SchiGT4_ZF"
								}
							}
						},
						trees_less_4meter_coverage: {
							title: "Deckungsgrad",
							description: "Gesamt-Deckungsgrad aller Bäume der Bestockung bis ca. 4 m Höhe",
							type: [
								"integer",
								"null"
							],
							$migration: {
								nfi2022: {
									...
									pointer: "bwineu.dbo.b3v_ecke_feld.SchiLE4_BeDG"
								}
							}
						},
						trees_less_4meter_layer: {
							title: "Schicht",
							description: "Schicht aller Bäume der Bestockung bis ca. 4 m Höhe",
							type: [
								"string",
								"null"
							],
							$migration: {
								nfi2022: {
									lookup: "lookup_trees_less_4meter_layer",
									source: [
										"b3v_ecke_feld",
										"0",
										"SchiLE4_Schi"
									],
									pointer: "bwineu.dbo.b3v_ecke_feld.SchiLE4_Schi"
								}
							}
						}
					}
	...
	//import schema from '../../schemas/schema_dereferenced.json'  with { type: "json" };

	//import TFM_Errors from './errors.js'; 

	const ajv = new Ajv({ allErrors: true, strict: false, format: false, verbose: true, logger: false });
	ajv.compile(schema);
	 ...
	 */
	function error(instancePath, message, type = 1, debugInfo = null) { // 1 = error, 2 = warning, 3 = info
	    if(!message )
	...
	class Plots {
	    ...
	    * Fehlertext: kein Baum im Hb (WZP4)
	    */
	    static checkTree_WZP4_829992 = async (plot, instancePath, previous_plot = {}) => {
	        ...
	        if (isforest && isaccessibility && plot.management_type) {
	            ...
	            if (standLayerEquals2.length === 0) {
	                errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                    instancePath,
	                    'kein Baum im Hb (WZP4)',
	                    1, 'checkTree_WZP4_829992=> plot:' + plot_name + ' cluster:' + cluster_id 
	                    // ecke verwenden
	                ));
	    ...
	    static checkTree_WZP4_829912 = async (plot, instancePath, previous_plot = {}) => {
	        ...
	        if (isnotforest || isnotaccessibility) {
	            ...
	            for (const tree of unvalidTrees) {
	                errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                    instancePath,
	                    'Es wurden WZP/ZF4-Bäume erfasst trotz Waldentscheid = kein Wald oder fehlender Begehbarkeit und  die Bäume nicht mehr zur Stichprobe gehören.',
	                    1, 'checkTree_WZP4_820512=> plot:' + plot_name + ' cluster:' + cluster_id + ' tree:' + tree.tree_number
	                    // ecke verwenden
	                ));
	    ...
	    /**
	    * @function checkTree_WZP4_829995
	    * @param {json} plot
	    * @param {string} instancePath
	    * @param {json} previous_plot
	    * @returns {Array} errors
	    * @author Thomas Stauber
	    * 
	    * Prüfung 829995:  keine Bäume im Hb,	Es wurden im Formular EBS (Ansicht Bäume über 4m Höhe) 
	    *  Bäume in der Hauptbestockung erfasst jedoch nicht bei der WZP4 im Hauptbestand	
	    *  Kontrollieren Sie bitte die Angaben zu Hauptbestand in EBS (Ansicht: bäume über 4m Höhe) mit die Bestandesschichtangaben 
	    *  in WZP4, 
	    * 
	    * Fehlermeldung:  Bäume in der Hauptbestockung erfasst jedoch keine in der WZP4 im Hauptbestand
	    */
	    static checkTree_WZP4_829995 = async (plot, instancePath, previous_plot = {}) => {
	    ...
	    */
	    static checkTree_WZP4_820540 = async (plot, instancePath, previous_plot = {}) => {
	        ...
	        for (const tree of unvalidTrees) {
	            ...
	            errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                instancePath,
	                'Bitte prüfen Sie, ob in Maske RAN Bestandesgrenzen vorhanden sind oder ob die Probebaumkennziffer korrigiert werden muss.',
	                1, 'checkTree_WZP4_820540=> plot:' + plot_name + ' cluster:' + cluster_id + ' tree:' + tree.tree_number
	    ...
	    */
	    static checkTree_WZP4_820538 = async (plot, instancePath, previous_plot = {}) => {
	        ...
	        for (const tree of unvalidTrees) {
	            ...
	            errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                instancePath,
	                'Die Probebaumkennziffer (Bk) muss größer als 1 sein, wenn der Waldentscheid ungleich 5 ist',
	                1, 'checkTree_WZP4_820538=> plot:' + plot_name + ' cluster:' + cluster_id + ' tree:' + tree.tree_number
	                //trakt und ecke verwenden
	            ));
	    ...
	    */
	    ...
	    static checkTree_WZP4_820533 = async (plot, instancePath, previous_plot = {}) => {
	        ...
	        for (const tree of validTrees) {
	            ...
	            errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                instancePath,
	                'Die Probebaumkennziffer (Bk) ist 1111="permanent markierter Hilfsbaum zum Wiederfinden der Traktecke", aber das Merkmal Perm ist ungleich 1. Bitte setzen Sie auch Perm auf 1, wenn der Baum permanent markiert ist oder ändern Sie die Probebaumkennziffer Bk ungleich 1111',
	                1, 'checkTree_WZP4_820533=> plot:' + plot_name + ' cluster:' + cluster_id + ' tree:' + tree.tree_number
	                //trakt und ecke verwenden
	            ));
	    ...
	    */
	    ...
	    static checkTree_WZP4_820911 = async (plot, instancePath, previous_plot = {}) => {
	        ...
	        for (const tree of validTrees) {
	            if ((tree.stand_layer !== null) && (management_type !== null)) {
	                if ((management_type === '2' || tree.stand_layer === '0') && tree.tree_height === null) {
	                    errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                        instancePath,
	                        'Fehler: Hat der Plot die Betriebsart 2 = Plenterwald oder die Bestandesschicht = 0, ist für jeden Baum die Höhe zu messen ',
	                        1, 'checkTree_WZP4_820916=> plot:' + plot_name + ' cluster:' + cluster_id + ' tree:' + tree.tree_number
	                        //trakt und ecke verwenden
	                    ));
	                }
	            }
	    ...
	    static checkTree_WZP4_820916 = async (plot, instancePath, previous_plot = {}) => {
	        ...
	        for (const tree of unvalidTrees) {
	            ...
	            if (tree.dbh !== null) {
	                errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                    instancePath,
	                    'Fehler: Brusthöhendurchmesser (Spalte BHD): Wert unmöglich, wenn der Baum als ausgefallen bzw. ausgeschieden gekennzeichnet wurde (Bk={4, 9,11,12})',
	                    1, 'checkTree_WZP4_820916=> plot:' + plot_name + ' cluster_name:' + cluster_id + ' tree_number:' + tree.tree_number
	                    //trakt und ecke verwenden
	                ));
	            }
	            ...
	            if ((tree.stand_layer !== null) && (management_type !== null)) {
	                if (management_type === '2' && tree.stand_layer !== '0') {
	                    errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                        instancePath,
	                        'Fehler: Hat der Plot die Betriebsart 2 = Plenterwald, ist für einen Baum die Bestandesschicht <> 0   unzulässig ',
	                        1, 'checkTree_WZP4_822611_822612=> plot:' + plot_name + ' cluster:' + cluster_id + ' tree:' + tree.tree_number
	                        //trakt und ecke verwenden
	                    ));
	                }
	        ...
	        if (('1' in counts) && ('3' in counts)) {
	            if (counts['1']['max'] > counts['3']['min']) {
	                errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                    instancePath,
	                    'Fehler: die Maximumhöhe des Hauptbestandes=1 ist höher als Minimumhöhe des Oberstandes=3',
	                    1, 'checkTree_WZP4_822613=> plot:' + plot_name + ' cluster:' + cluster_id
	                    //trakt und ecke verwenden
	                ));
	            }
	        }
	    ...
	    * @author Thomas Stauber
	    * 
	    * 821313	WZP4	Baumhöhe  fehlt	: Mindestens eine Baumhöhenmessung in einer Baumartengruppe innererhalb Bestand
	    ...
	    * 
	    */
	    static checkTree_WZP4_821322 = async (plot, instancePath, previous_plot = {}, api) => {
	        ...
	        for (let varStandLayer = 1; varStandLayer < 4; varStandLayer++) {
	            ...
	            for (const tree of standLayerEquals2) {
	                ...
	                if (!speciesObject || !speciesObject.height_group) {
	                    console.log(speciesObject, speciesObject['height_group']);
	                    return [
	                        error(
	                            instancePath,
	                            `Tree type ${tree.tree_species} not found in lookup Table`,
	                            1,
	                            'checkTree_WZP4_821322=>plot:' + plot_name + ' cluster:' + cluster_id
	                        )
	                    ];
	                }
	                //select height_group 
	            ...
	            if (groupedStandLayerEquals3withheight_group.length > 0) {
	                ...
	                Object.keys(counts).forEach(key => {
	                    if (counts[key] === 0) {
	                        errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                            instancePath,
	                            // 'The count of tree_heights for trees with stand_layer =' + varStandLayer + ' grouping by height_group must be greater then 0',
	                            'Die Anzahl der Baumhöhen für Bäume mit Bestandesschicht = ' + varStandLayer + ', die nach Baumarten gruppiert sind, muss größer als 0 sein. ',
	                            1, 'checkTree_WZP4_821322=>plot:' + plot_name + ' cluster:' + cluster_id
	                            //trakt und ecke verwenden
	                        ));
	                    }
	                });
	     ...
	     * @author Thomas Stauber
	     * 
	     * Mindestens eine Baumhöhe der häufigsten Baumartengruppe (Spalte 'BaGr_H' = ...) des Hauptbestandes fehlt (Spalte 'Bs' = 1) fehlt.
	     * Fehlermeldung:************
	     ...
	     */
	    static checkTree_WZP4_821320 = async (plot, instancePath, previous_plot = {}, api) => {
	        let errors = [];
	        let plot_name = plot.plot_name;
	        let cluster_id = plot.cluster_id;
	        ...
	        if (groupedStandLayerEquals2withheight_group.length > 0) {
	            ...
	            if (counts[maxKey]['TreeGroupNumberHeights'] < 2 && counts[maxKey]['TreegroupNumber'] > 1) {
	                errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                    instancePath,
	                    'Wenn die Baumanzahl in der häufigsten Baumartengruppe im Hauptbestand > 1 ist, dann müssen mindestens 2 Baumhöhenmessungen in dieser größten Baumartengruppe vorliegen.',
	                    // 'At least one tree height of the most common tree species group of the main stand is missing',
	                    1, 'checkTree_WZP4_821320=>plot:' + plot_name + ' cluster:' + cluster_id
	                ));
	            }
	    ...
	    */
	    ...
	    static checkTree_WZP4_821321 = async (plot, instancePath, previous_plot = {}, api) => {
	        let errors = [];
	        let plot_name = plot.plot_name;
	        let cluster_id = plot.cluster_id;
	        ...
	        if (groupedStandLayerEquals2withtaxonomy_order.length > 0) {
	            ...
	            Object.keys(counts).forEach(key => {
	                if (counts[key] === 0) {
	                    errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                        instancePath,
	                        // 'The count of tree_heights for trees with stand_layer = 2 grouping by taxonomy order must be greater then 0',
	                        'Die Anzahl der Baumhöhen für Bäume in Bestandesschicht = 2, die nach Taxonomieordnung gruppiert sind, muss größer als 0 sein.',
	                        1, 'checkTree_WZP4_821321=>plot:' + plot_name + ' cluster:' + cluster_id
	                    ));
	                }
	            });
	        }
	...
	class Calc {
	   ...
	   * 
	   * Bestimmt Grenztoleranz aus mittlerer Messhöhe (dbh_height),  M_bhd (dbh) und  siehe Ebn.Ableitungen.Berechnungen
	   */
	...
	class Trees {
	    ...
	    */
	    static checkTree_WZP4_829921 = async (tree, instancePath, previous_tree = {}) => {
	        ...
	        let errors = [];
	        if (tree.tree_number === previous_tree.tree_number && Number(tree.tree_status) < 2) {
	            if (Number(tree.tree_height) - Number(previous_tree.tree_height) > 200) {
	                errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                    instancePath,
	                    'Höhenzuwachs unwahrscheinlich, Höhenzuwachs zur Vorgängerinventur > 200 dm',
	                    2, 'checkTree_WZP4_829921=> tree:' + tree.tree_number
	                    // ecke verwenden
	                ));
	            }
	    ...
	    */
	    ...
	    static checkTree_WZP4_820524 = async (tree, instancePath, previous_tree = {}) => {
	        ...
	        if (tree.tree_number === previous_tree.tree_number && Number(previous_tree.tree_status) < 2000 && Number(tree.tree_status) > 2000) {
	            errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                instancePath,
	                'Die Probebaumkennziffer Bk darf nicht größer als 2000 sein, wenn der Baum in der Vorgängerinventur nicht ausgefallen ist.',
	                1, 'checkTree_WZP4_820524=> tree:' + tree.tree_number
	                // ecke verwenden
	            ));
	        }
	    ...
	    */
	    static checkTree_WZP4_820521 = async (tree, instancePath, previous_tree = {}) => {
	        ...
	        if (tree.tree_number === previous_tree.tree_number && Number(previous_tree.tree_status) > 2000 && Number(tree.tree_status) < 2000) {
	            errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                instancePath,
	                'Der Baum wurde schon bei einer Vorgängerinventur als ausgeschieden deklariert. Die Probebaumkennziffer Bk muss daher größer 2000 sein und Bk_Soll entsprechen',
	                1, 'checkTree_WZP4_820521=> tree:' + tree.tree_number
	                // ecke verwenden
	            ));
	        }
	    ...
	    */
	    ...
	    static checkTree_WZP4_820531_820532 = async (tree, instancePath, previous_tree = {}) => {
	        ...
	        if (tree.tree_number === previous_tree.tree_number && previous_tree.tree_status === '1111' && (tree.tree_status != 0 || tree.tree_status != 8)) {
	            errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                instancePath,
	                'Die Probebaumkennziffer Bk darf nur auf Pk=0 oder Pk=8 geändert werden, da in Vorgängerinventur  Hilfsbaum (Pk=1111) und aktuell in der Stichprobe ist',
	                1, 'checkTree_WZP4_820531=> tree:' + tree.tree_number
	                // ecke verwenden
	            ));
	        }
	        ...
	        if (tree.tree_number === previous_tree.tree_number && previous_tree.tree_status != '1111' && tree.tree_status === '1111') {
	            errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                instancePath,
	                'Der Baum war bei der Vorgängerinventur kein Hilfsbaum (Pk!=1111) und ist nun ein Hilfsbaum',
	                1, 'checkTree_WZP4_820532=> tree:' + tree.tree_number
	                // ecke verwenden
	            ));
	        }
	    ...
	    static checkTree_WZP4_829911_829915 = async (tree, instancePath, previous_tree = {}) => {
	        ...
	        if (tree.distance > grenztoleranz && (tree.tree_status == 1 || tree.tree_status == 0)) {
	            errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                instancePath,
	                'Die Grenztoleranz ist kleiner als die Horizontalentfernung (distance), Baum gehört nicht zur Stichprobe',
	                1, 'checkTree_WZP4_829911_829915=> tree:' + tree.tree_number
	                //trakt und ecke verwenden
	            ));
	        }
	     ...
	     */
	    static checkTree_WZP4_821318 = async (tree, instancePath, previous_tree = {}) => {

	        let errors = [];


	        if (tree.tree_number === previous_tree.tree_number && tree.tree_height != null && tree.tree_height <= previous_tree.tree_height) {
	            errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                instancePath,
	                'die aktuelle Baumhöhe [dm] ist kleiner oder gleich als der bei der Vorgängerinventur',
	                2, 'checkTree_821318=> tree:' + tree.tree_number
	                //trakt und ecke verwenden
	            ));
	        }
	    ...
	    /**
	    * @function checkTree_WZP4_821913
	    * @param {json} plot
	    * @param {string} instancePath
	    * @param {json} previous_plot
	    * @returns {Array} errors
	    * @author Thomas Stauber
	    * 
	    * Prüfung 821913: (auf 130cm Messhöhe umgerechneter) Brusthöhendurchmesser (Spalte 'Bhd130') < 70mm	Baum gehört nicht zur WZP-Stichprobe
	    *
	    ...
	    */
	    static checkTree_WZP4_821913 = async (tree, instancePath, previous_tree = {}) => {
	        ...
	        if (tree.tree_marked === false && tree.tree_status != 8 && tree.dbh != null && tree.dbh < 70) {
	            errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                instancePath,
	                ' Ein auf 130cm Messhöhe umgerechneter Brusthöhendurchmesser ist kleiner als 70mm und  gehört damit nicht zur WZP-Stichprobe',
	                1, 'checkTree_821913=> tree:' + tree.tree_number
	                //trakt und ecke verwenden
	            ));
	        }
	    ...
	    */
	    static checkTree_821315 = async (tree, instancePath, previous_tree = {}) => {
	        ...
	        if (Calc.height_suitability(tree)) {
	            ...
	            if (tree.tree_number === previous_tree.tree_number && tree.tree_height === null && previous_tree.tree_height != null) {
	                errors.push(error( // instancePath, message, type = 1, debugInfo = Null
	                    instancePath,
	                    'Ein Höhenbaum aus der Vorgängerinventur ist nicht als erneuter Höhenmessbaum verwendet worden',
	                    2, 'checkTree_821315=> tree:' + tree.tree_number
	                    //trakt und ecke verwenden
	                ));
	            }
	        }
	...
	class API {
	    ...
	    lookupByAbbreviation = async (lookupTableName, abbreviation) => {
	        ...
	        return tableData.filter(row => {
	            //if(abbreviation === '10') console.log(row.abbreviation, abbreviation, row.abbreviation == abbreviation);
	            return row.abbreviation == abbreviation;
	        })[0];
	    }
	}
	    ...
	    */
	    ...
	    async runCluster(clusters, instancePath = '/clusters', previous_cluster = {}) {
	        return new Promise(async (resolve, reject) => {
	            ...
	            for (let i = 0; i < clusters.length; i++) {
	                errors = await this.runAll(Cluster, clusters[i], instancePath + `/${i}`, previous_cluster[i]);
	                if (errors.length === 0 && clusters[i].plots) {
	                    errors = [...errors, await this.runPlots(clusters[i].plots, instancePath + `/plots`, previous_cluster[i]?.plots || {})];
	                }
	            }    
	    ...
	    async runPlots(plots, instancePath = '', previous_plot) {
	        ...
	        for (let i = 0; i < plots.length; i++) {
	            errors = await this.runAll(Plots, plots[i], instancePath + `/${i}`, previous_plot[i]);
	            if (errors.length === 0 && plots[i].trees) {
	               errors = [...errors, await this.runTrees(clusters[i].trees, instancePath + `/trees`, previous_cluster[i].trees || {})];
	            }
	        }
	    ...
	    async runTrees(trees, instancePath = '', previous_trees) {
	        ...
	        for (let i = 0; i < trees.length; i++) {
	            errors = await this.runAll(Trees, trees[i], instancePath + `/${i}`, previous_trees[i]);
	           
	        }
	        if (errors.length > 0) {
	            return errors;
	        }
	        console.log('TRees', errors);
	        return errors;
	    }
	}
